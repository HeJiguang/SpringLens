...
@Component
public class InvokeRuntimeToolTool implements DiagnosticTool {

    private final ApplicationRegistryService registryService;
    private final RuntimeObservationClient runtimeObservationClient;

    public InvokeRuntimeToolTool(ApplicationRegistryService registryService, RuntimeObservationClient runtimeObservationClient) {
    ...
    public ToolDescriptor descriptor() {
        return new ToolDescriptor("invoke_runtime_tool", "Invoke a capability-contributed runtime tool on a registered application.");
    }
    ...
    public Map<String, Object> inputSchema() {
        ...
        properties.put("toolName", ToolJsonSchemas.stringProperty("Runtime tool name."));
    ...
    public Object execute(ToolRequest request) {
        ...
        Map<String, Object> argumentMap = arguments instanceof Map<?, ?> values
                ...
                : Map.of();
        return runtimeObservationClient.invokeRuntimeTool(registration, String.valueOf(toolName), argumentMap);
    }
}
