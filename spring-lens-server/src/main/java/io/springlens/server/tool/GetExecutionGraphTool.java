...
@Component
public class GetExecutionGraphTool implements DiagnosticTool {

    private final ApplicationRegistryService registryService;
    private final RuntimeObservationClient runtimeObservationClient;

    public GetExecutionGraphTool(ApplicationRegistryService registryService, RuntimeObservationClient runtimeObservationClient) {
    ...
    public ToolDescriptor descriptor() {
        return new ToolDescriptor("get_execution_graph", "Fetch a structured execution graph by execution id.");
    }
    ...
    public Map<String, Object> inputSchema() {
        ...
        properties.put("executionId", ToolJsonSchemas.stringProperty("Execution id to load."));
    ...
    public Object execute(ToolRequest request) {
        ...
        return runtimeObservationClient.getExecutionGraph(registration, String.valueOf(executionId));
    }
}
